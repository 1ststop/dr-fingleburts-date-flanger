...
export default {
  props: {
    ...
    maxDay: {type: Number, default:null},
    maxMonth: {type: Number, default:null}
  },
  components: {
    Select
  },
  ...
  methods: {
    ...
    //   }
      ...
      console.log("maxDateValue: ", this.maxDateValue)
      console.log("maxDateValueFullYear: ", new Date(this.maxDateValue).getFullYear())
      console.log("maxDateMnth: ", new Date(this.maxDateValue).getMonth())
      console.log("maxDateDay: ", new Date(this.maxDateValue).getDate())
      ...
      if(new Date(this.maxDateValue).getFullYear() === this.currentYear)
      {
          if (this.month > this.currentMonth)
          {
              if (this.day >= this.currentDay)
              {
                  maxYear = new Date(this.maxDateValue).getFullYear()-1;
              }
          }
      }
      ...
      if (this.maxDateValue !== null && (month > new Date(this.maxDateValue).getMonth() && day >= new Date(this.maxDateValue).getDate()))
      {
          console.log("made it")
        maxYear = new Date(this.maxDateValue).getFullYear()-1;
      }
